...
function CollegeForm_Filter({ onClose, onApply, initialFilter }) {
  ...
  useEffect(() => {
    ...
    setSortBy(initialFilter.sort_by);
  }, [initialFilter]);

  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/30">
      <div className="bg-white p-6 rounded-lg shadow-xl w-96 space-y-6">
        <h2 className="text-lg font-bold text-gray-600">Filter Colleges</h2>

        {/* filter by */}
        <div>
          <p className="font-medium mb-2 text-gray-500">Filter By</p>
        ...
        {/* order */}
        <div>
          <p className="font-medium mb-2 text-gray-500">Order</p>
          <div className="flex flex-col gap-2">
            <label className="cursor-pointer flex items-center gap-2">
              <input
                type="radio"
        ...
        {/* sort by */}
        <div>
          <p className="font-medium mb-2 text-gray-500">Sort By</p>
          <div className="flex flex-col gap-2">
            <label className="cursor-pointer flex items-center gap-2">
              <input
                type="radio"
...
export default CollegeForm_Filter;
