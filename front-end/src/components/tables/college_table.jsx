...
function CollegeTable() {
  ...
  // ✅ UPDATED: handleSave ensures latest data is loaded
  ...
  // ✅ UPDATED: handleDelete keeps window.confirm but re-fetches data properly
  const handleDelete = async (code) => {
    ...
    try {
      ...
      // If page becomes empty but not the first page → go back one page
